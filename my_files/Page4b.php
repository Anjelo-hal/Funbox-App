...
<body id="body4">
	...
	<?php
						...
						$query1 = "SELECT * FROM products where id = 8";
						$result1 = $conn->query($query1);
						$row1 = mysqli_fetch_row($result1);
						
						$query2 = "SELECT * FROM products where id = 9";
						$result2 = $conn->query($query2);
						$row2 = mysqli_fetch_row($result2);
						
						$query3 = "SELECT * FROM products where id = 10";
						$result3 = $conn->query($query3);
						$row3 = mysqli_fetch_row($result3);
						
						$query4 = "SELECT * FROM products where id = 11";
						$result4 = $conn->query($query4);
						$row4 = mysqli_fetch_row($result4);
						
						$query5 = "SELECT * FROM products where id = 12";
...
<section class="container content-section" id="list-id">
            <h2 class="section-header">RPG GAMES</h2>
        ...
        <button class="btn btn-primary btn-purchase" onclick="window.location.href='Page4b.php'">PREVIOUS</button>
...
function updateCartTotal() {
	...
	<div class="ch">
		...
		<input id="delo" type="checkbox" onclick="updateCartTotal()">
			<label id="deli" for="vehicle1">For express delivery (plus 6$)</label><br>
